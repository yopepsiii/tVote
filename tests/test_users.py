...
@pytest.mark.asyncio
@pytest.mark.parametrize('firstname, surname, email, password, status',
                         [
...
async def test_create_user(admin_client, firstname, surname, email, password, status,
                           fastapi_cache):
    res = admin_client.post('/users',
                            json={'firstname': firstname, 'surname': surname, 'email': email, 'password': password})
...
async def test_create_user_owner(owner_client, firstname, surname, email, password, status,
                                 fastapi_cache):
    res = owner_client.post('/users',
                            json={'firstname': firstname, 'surname': surname, 'email': email, 'password': password})
    assert res.status_code == status
    if status == 201:
        new_user = res.json()
...
@pytest.mark.parametrize('firstname, surname, email, password',
                         [
...
def test_create_user_user(authorized_client, firstname, surname, email, password,
                          fastapi_cache):
    res = authorized_client.post('/users',
                                 json={'firstname': firstname, 'surname': surname, 'email': email,
                                       'password': password})
    assert res.status_code == 403
...
async def test_create_user_unauthorized(client, firstname, surname, email, password,
                                        fastapi_cache):
...
async def test_update_user(admin_client, test_user, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
...
async def test_update_admin(admin_client, test_admin2, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
    update_data = {k: v for k, v in data.items() if v is not None}
...
async def test_update_owner(admin_client, test_owner, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
    update_data = {k: v for k, v in data.items() if v is not None}
...
async def test_update_user_owner(owner_client, test_user, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
    update_data = {k: v for k, v in data.items() if v is not None}
...
async def test_update_user_user(authorized_client, test_user, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
    update_data = {k: v for k, v in data.items() if v is not None}
...
async def test_update_user_unauthorized(client, test_user, firstname, surname, email, password, fastapi_cache):
    data = {'firstname': firstname, 'surname': surname, 'email': email, 'password': password}
    update_data = {k: v for k, v in data.items() if v is not None}

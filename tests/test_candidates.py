...
parametrs = [
                             ('test-name', 'test-surname', 1, 'test-group', 'test-study-dirrection',
                              'test-photo', 201),
                             (1, 'test-surname', 'TEXT', 'test-group', 'test-study-dirrection',
                              'test-photo', 422),
                             (None, 'test-surname', 1, 'test-group', 'test-study-dirrection',
                              'test-photo', 422),
...
def test_get_candidates(admin_client, fastapi_cache):
    data = {'firstname': 'test', 'surname': 'test', 'year_of_study': 1, 'group': 'test', 'study_dirrection': 'test', 'photo': 'test'}
...
@pytest.mark.parametrize('firstname, surname, year_of_study, group, study_dirrection, photo, status',
                         [
                             ('test-name', 'test-surname', 1, 'test-group', 'test-study-dirrection',
                              'test-photo', 201),
                             (1, 'test-surname', 'TEXT', 'test-group', 'test-study-dirrection',
...
def test_create_candidate(admin_client, fastapi_cache, firstname, surname, year_of_study, group,
                          study_dirrection, photo, status):
    data = {'firstname': firstname, 'surname': surname, 'year_of_study': year_of_study, 'group': group, 'study_dirrection': study_dirrection, 'photo': photo}
...
def test_create_candidate_owner(owner_client, fastapi_cache, firstname, surname, year_of_study, group,
                                study_dirrection, photo, status):
    data = {'firstname': firstname, 'surname': surname, 'year_of_study': year_of_study, 'group': group, 'study_dirrection': study_dirrection, 'photo': photo}
...
@pytest.mark.parametrize('firstname, surname, year_of_study, group, study_dirrection, photo',
                         [
                             ('test-name', 'test-surname', 1, 'test-group', 'test-study-dirrection',
                              'test-photo'),
                             (1, 'test-surname', 'TEXT', 'test-group', 'test-study-dirrection',
...
def test_create_candidate_user(authorized_client, fastapi_cache, firstname, surname, year_of_study, group,
...
def test_create_candidate_unauthorized(client, fastapi_cache, firstname, surname, year_of_study, group,
                                       study_dirrection, photo):
    data = {'firstname': firstname, 'surname': surname, 'year_of_study': year_of_study, 'group': group, 'study_dirrection': study_dirrection, 'photo': photo}
...
def test_update_candidate_wrong_id(admin_client, fastapi_cache):
    data = {'firstname': 'test-name', 'surname': 'test-surname', 'year_of_study': 1, 'group': 'test-group', 'study_dirrection': 'test-study-dirrection', 'photo': 'test-photo'}
